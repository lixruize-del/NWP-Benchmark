...
from src.common.data_reader import DEFAULT_ERA5_NPY_ROOT, Era5NpyLayout, load_npy_2d  # src:/vepfs data reader
...
def _load_model(device: str) -> Aurora:  # src:/home/NWP-Benchmark/src/aurora/inference.py:138-165
    weights_path = DEFAULT_WEIGHTS_ROOT / "aurora" / "aurora-0.25-pretrained.ckpt"  # src:/home/NWP-Benchmark/src/aurora/inference.py:142-143 adapted
    ...
    model = Aurora(use_lora=False)  # src:/home/NWP-Benchmark/src/aurora/inference.py:149
    ...
    with patch("aurora.model.aurora.hf_hub_download", side_effect=fake_download):  # src:/home/NWP-Benchmark/src/aurora/inference.py:157
        model.load_checkpoint("microsoft/aurora", "aurora-0.25-pretrained.ckpt")  # src:/home/NWP-Benchmark/src/aurora/inference.py:158
