...
def download_weights():
    ...
    # NeuralGCM 1.4 degree deterministic model
    gcs_path = "gs://gs://neuralgcm/models/v1/deterministic_1_4_deg.pkl"
    local_filename = "models_v1_deterministic_1_4_deg.pkl"
